-- Migration: tb_event_hut
-- Menyimpan seluruh data registrasi HUT Kota Makassar dari workflow API
-- (event_type=hut) sebagai sumber data utama dashboard.
-- Diisi/diperbarui oleh scripts/warmup-hut.mjs (upsert).
-- Dijalankan sekali: mysql ... superapps < sql/003_tb_event_hut.sql

CREATE TABLE IF NOT EXISTS tb_event_hut (
  id                   BIGINT       NOT NULL,
